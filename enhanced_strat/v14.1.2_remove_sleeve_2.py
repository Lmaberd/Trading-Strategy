"""
EnhancedStrategy V14.1.2: Remove Sleeve 2
=========================================
Technical-only variant based on V14.

Changes from V14:
  - removes all sentiment preprocessing and FinBERT usage
  - removes Sleeve 2 position management and entries
  - keeps the fast weekly analytics pipeline and Sleeve 1 logic
...
class EnhancedStrategy(BaseStrategy):
    ...
    def _build_weekly_market_views(self, weekly_df):
        if weekly_df.empty:
            return {}, {}
    ...
    def _select_universe_from_latest(self, latest_dict):
        ...
        return {ticker for ticker, score in zip(valid_tickers, composite) if score >= threshold}
    ...
    def evaluate(self, verbose=False):
        ...
        weekly_records, weekly_prices = self._build_weekly_market_views(weekly_analytics)
