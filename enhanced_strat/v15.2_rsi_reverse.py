"""
EnhancedStrategy V15.2: Adaptive RSI Reverse Parkinson Volatility
====================================================
...
class EnhancedStrategy(BaseStrategy):
    ...
    def __init__(self, finbert_pipeline=None, rsi_threshold=40, vol_mult=2,
        ...
        self.reversal_sma_multiplier = reversal_sma_multiplier
    ...
    def make_decision(self, ticker, date, transcript, portfolio_state, analytics):
        ...
        reversal_below_sma = (
            ma_200 is not None
            and price < (self.reversal_sma_multiplier * ma_200)
        )
        ...
        rsi_entry_threshold = 30 if reversal_below_sma else self.rsi_threshold

        s1_trigger = False
        if rsi is not None and not np.isnan(rsi) and rsi < rsi_entry_threshold and not vol_veto:
            s1_trigger = True
